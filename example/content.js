import createEditorPlugins from '@serlo-org/editor-plugins/src'
import PluginService from '@splish-me/ory-editor-core/lib/service/plugin'

import ScPlugin from '../plugins/sc-mc-exercise/src'
import TextPlugin from '../plugins/input-exercise/src'

const plugins = new PluginService({
  content: createEditorPlugins()
})

export const content = plugins.serialize(
  plugins.unserialize({
    id: '1',
    cells: [
      {
                ...
                rows: [
                  ...
                  },
                  {
                    cells: [
                      {
                        content: {
                          plugin: { name: '@serlo-org/geogebra' },
                          state: {
                            alt: 'Dreiecke konstruieren',
                            src: '1571395'
                          }
                        }
                      }
